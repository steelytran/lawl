...
int main(void)
{
	...
	Wall wall0 = {200, 200, 100, 200, RED, 1};
	Wall wall1 = {100, 200, 100, 100, GREEN, 1};
	Wall wall2 = {100, 100, 200, 100, BLUE, 1};
	Wall wall3 = {200, 100, 200, 200, WHITE, 1};
